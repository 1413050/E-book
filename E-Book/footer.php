    ...
    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5 d-flex align-items-center justify-content-center">
        <div class="row px-xl-5 pt-5 align-items-center justify-content-center container">
            <div class="col-lg-5 col-md-12 mb-5 pr-3 pr-xl-5">
                <h5 class="text-secondary text-uppercase mb-4">Get In Touch</h5>
                <p class="mb-4">No dolore ipsum accusam no lorem. Invidunt sed clita kasd clita et et dolor sed dolor. Rebum tempor no vero est magna amet no</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, New York, USA</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>azmeershah621@gmail.com</p>
